...
import {DriverChunkInfo, DriverLoggable, DriverOpenClose, DriverStatus} from "./Interface"
...
import {InterfaceAdbLogcatSettings, InterfaceType} from "../../common/model/profile/Interface";
...
export class DriverAdbLogcat implements DriverOpenClose {
    ...
    constructor(readonly params: InterfaceAdbLogcatSettings) {
        this.name = InterfaceType.InterfaceWebAdb
